...
namespace KSPPluginFramework
{
    ...
    public static class ExtensionMethods
    {
        ...
        // Yes, Virginia, there is a Santa Claus. String Concatenation of two strings is fast.
        // And once we do it, we never have to do it again since we've cached the result.
